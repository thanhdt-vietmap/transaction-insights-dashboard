...
const API_URL = "http://192.168.22.151:3000/api/get-daily-req";
...
const enrichedSampleData: AccountData[] = [
  ...
  },
  {
    ...
    valid_txn_cnt_range_before: 298765432.1,
    diff: 22691357.22,
    account_type: "ENTERPRISE",
  },
  {
...
export const fetchData = async (
  ...
  try {
    ...
    const response = await fetch(
      `${API_URL}?fromDate=${fromDate}&toDate=${toDate}`
    );
